...
CON: 14 (70%)    |  WP: 12         |  Breaking Point: 40
DEX: 12 (60%)    |  Armor: 0       |  Disorder: OCD (Volkov-fokuserad)
INT: 12 (60%)    |  
POW: 12 (60%)    |  Adapted to Violence: 2/5
CHA: 10 (50%)    |  Adapted to Helplessness: 1/5
```
...
2023 (november) - Operation Mall Before Christmas - 5 SAN-förlust
2025 (juni) - Operation Sea Glass - Breaking Point (6 SAN-förlust)
...
2023 (nov) - The Mall Before Christmas - 5 SAN förlust
2025 (juni) - Operation Sea Glass - BREAKING POINT (6 SAN förlust)
```
...
**Sektion: DISORDER**
```
DIAGNOS: Obsessive Compulsive Disorder (Volkov-fokuserad)
URSPRUNG: Breaking Point efter Operation Sea Glass (juni 2025)
...
**Sektion: ADAPTATIONS**
```
ADAPTED TO VIOLENCE: 2/5
- 13 dödsfall bevittnade över 7 år
- 3 dödsfall direkt orsakade
- Kan hantera våld utan SAN-checks (upp till en viss nivå)

ADAPTED TO HELPLESSNESS: 1/5
